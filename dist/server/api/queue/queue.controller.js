...
var child_process = require("child_process").fork("server/components/queue/index.js", [], { execArgv: ['--debug=5859'] });
var consumer = require("child_process").fork("server/components/queue/index.js", [], { execArgv: ['--debug=5860'] });
...
var translateTweet = function translateTweet(tweet, validateMedia, validateLocation) {
