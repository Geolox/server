...
<body>
    ...
    $(document).ready(function () {
    	$("#messages").flexigrid({
			url: 'messages.php?queue=streetreport&exchange=transit',
			dataType: 'json',
			colModel : [
			  {name : 'info', hide: true},
			  {display: 'Date', name : 'reportd', width : 100, sortable : true},
			  {display: 'Cathegory', name : 'catname', width : 110, sortable : true},
			  {display: 'Sub-Cathegory', name : 'subcat_name', width : 115, sortable : true},
			  {display: 'Description', name : 'desc', width : 150,sortable : true},
