...
require_once('php-amqplib/PhpAmqpLib/Channel/AMQPChannel.php');
require_once('php-amqplib/PhpAmqpLib/Connection/AMQPConnection.php');
require_once('php-amqplib/PhpAmqpLib/Exception/AMQPConnectionException.php');
require_once('php-amqplib/PhpAmqpLib/Helper/MiscHelper.php');
require_once('php-amqplib/PhpAmqpLib/Wire/AMQPWriter.php');
require_once('php-amqplib/PhpAmqpLib/Wire/AMQPReader.php');
